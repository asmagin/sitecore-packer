        ...
        if ($PSCmdlet.ShouldProcess($Name, $Action)) {
            switch ($Action) {
                ...
                'Create-Website' {
                    ...
                    Write-Host "Using provided certificate: $CertificateThumbprint" -ForegroundColor Green
                    ...
                    New-WebBinding -Name $Name -HostHeader $Hostname -Protocol "https" -SslFlags 1 -Port $Port
                    ...
                    $binding = Get-WebBinding -Name $Name -HostHeader $Hostname -Protocol "https"
