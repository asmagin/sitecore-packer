...
Function Invoke-UpdateShopsPortTask {
    ...
    param(
        ...
        [string]$CommerceAuthoringHostHeader,
        [Parameter(Mandatory = $true)]
    ...
    $node.shopsServiceUrl = $node.shopsServiceUrl.replace("localhost", $CommerceAuthoringHostHeader)
    $node.commerceOpsServiceUrl = $node.commerceOpsServiceUrl.replace("localhost", $CommerceAuthoringHostHeader)
