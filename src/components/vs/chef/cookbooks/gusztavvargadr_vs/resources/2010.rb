...
action :install do
  directory_path = "#{Chef::Config[:file_cache_path]}/gusztavvargadr_vs/2010_#{edition}"
  ...
  installer_file_source = node['gusztavvargadr_vs']["2010_#{edition}"]['installer_file_url']
